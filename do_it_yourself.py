...
Тому у форматі вивода помилок зроблено припущення, що в списку помилок для відображення, 
номер помилки - це порядковий номер масиву помилок, і виводиться перша знайдена помилка.
'''